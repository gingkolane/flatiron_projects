...
//Native environment, click "Next Lesson" div, open a modal, 
// with new form in a popup window

// const nextLessonDivTag = document.getElementById('next-lesson');
// const modal = document.getElementById("my-modal");

// nextLessonDivTag.addEventListener('click', function(){
...
//   // create a new completion record on form submission 
//   newForm.addEventListener('submit', function (event) {
//     event.preventDefault();
