...
ActiveRecord::Schema.define(version: 2019_06_17_224045) do
  ...
  create_table "investigators_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.integer "list_id"
